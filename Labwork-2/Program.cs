...
namespace Labwork_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int offset_0 = 0; 
            int offset_1 = 1; // Оффсеты - числа, увеличивающие своё значение с каждой итерацией цикла while (currentValue > 0). Необходимы для постепенного "сужения" к центру массива при выводе его в виде спирали.
            int offset_2 = 2;
